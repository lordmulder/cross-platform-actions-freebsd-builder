...
curl -sSf https://download.freebsd.org/releases/amd64/amd64/15.1-RELEASE/lib32.txz | tar -C / -xJ usr/lib32
curl -sSf https://download.freebsd.org/ftp/releases/arm64/15.1-RELEASE/base.txz | tar -C /opt/sysroot/arm64 -xJ lib usr/lib
